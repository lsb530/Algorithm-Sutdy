...
public class Sol39 {
    ...
    public static void main(String[] args) {
        int answer1 = solution(new String[]{"SOOOL", "XXXXO", "OOOOO", "OXXXX", "OOOOE"});
        System.out.println(answer1); // 16


        int answer2 = solution(new String[]{"LOOXS", "OOOOX", "OOOOO", "OOOOO", "EOOOO"});
    ...
    public static int solution(String[] maps) {
        ...
        // 도착 불가능한 경우는 -1, 도착 가능한 경우는 최단거리를 반환
